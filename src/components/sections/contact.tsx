...
let email = 'kshitijhereforit@gmail.com';
let phone = '+91 7666960976';
  ...
  return (
    <Container id="contact">
      <div className="flex flex-col items-center gap-4">
        ...
        data analyst, have a query, or simply want to connect.
        </Typography>
      </div>
...
<div className="flex flex-col items-center gap-2 mt-8">
  ...
  <QRCodeCanvas
    value="https://my-portfolio-iota-silk-46.vercel.app" // Replace with your actual URL
    size={128}
    fgColor="#000000"
    bgColor="#ffffff"
